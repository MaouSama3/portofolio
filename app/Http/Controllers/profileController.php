...
class profileController extends Controller
{
    ...
    function update(Request $request)
    {
        $request->validate([
            ...
            '_foto.mimes' => 'Foto yang di masukkan hanya di perbolehkan berformat JPEG, JPG, PNG dan GIF',
            '_email.required' => 'Email wajid diisi',
        ...
        return redirect()->route('profile.index')->with('success', 'Berhasil menambahkan data profile');
    }
}
