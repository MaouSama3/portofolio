...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required' => 'Posisi wajid diisi',
                'info1.required' => 'Nama Perusahaan wajid diisi',
                'tgl_mulai.required' => 'Tanggal mulai wajid diisi',
                'isi.required' => 'isian tulisan tidak boleh kosong',
            ]
    );
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'tgl_mulai.required' => 'Tanggal mulai wajid diisi',
                'isi.required' => 'isian tulisan tidak boleh kosong',
                'isi.min' => 'isian tulisan tidak boleh kosong',
            ]
    );
