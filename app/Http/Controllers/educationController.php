...
class educationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required' => 'Univesitas wajid diisi',
                'info1.required' => 'Nama fakultas wajid diisi',
                'info2.required' => 'Nama prodi wajid diisi',
                'tgl_mulai.required' => 'Tanggal mulai wajid diisi',
    ...
    return redirect()->route('education.index')->with('success', 'Berhasil menambahkan data Sekolah');
    }
    ...
    return redirect()->route('education.index')->with('success', 'Berhasil update data Sekolah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Berhasil menghapus data Sekolah');
    }
}
