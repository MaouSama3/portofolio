        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#education">Sekolah</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#skills">Skills</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#interests">Minat</a></li>
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="social-icons">
                        @if ($linkedin = get_meta_value('_linkedin'))
                            <a class="social-icon" href="{{ $linkedin }}"><i class="fab fa-linkedin-in"></i></a>
                        @endif
                    
                        @if ($github = get_meta_value('_github'))
                            <a class="social-icon" href="{{ $github }}"><i class="fab fa-github"></i></a>
                        @endif
                    
                        @if ($twitter = get_meta_value('_twitter'))
                            <a class="social-icon" href="{{ $twitter }}"><i class="fab fa-twitter"></i></a>
                        @endif
                    
                        @if ($facebook = get_meta_value('_facebook'))
                            <a class="social-icon" href="{{ $facebook }}"><i class="fab fa-facebook-f"></i></a>
                        @endif
                    </div>
