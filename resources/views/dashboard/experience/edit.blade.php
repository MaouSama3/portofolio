...
<form action="{{ route('experience.update', $data->id) }}" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text"
        class="form-control form-control-sm" name="judul" id="judul" aria-describedby="helpId" placeholder="Masukkan Posisi" value="{{ $data->judul }}">
    </div>

    <div class="mb-3">
      <label for="info1" class="form-label">Nama Perusahaan</label>
      <input type="text"
        class="form-control form-control-sm" name="info1" id="info1" aria-describedby="helpId" placeholder="Masukkan Nama Perusahaan" value="{{ $data->info1 }}">
    </div>
